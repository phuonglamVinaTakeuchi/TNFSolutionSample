...
{
    public class NormalBeamDraw : BeamDrawingBase
    {
        public NormalBeamDraw(BeamSectionGBase beamGeometry) : base(beamGeometry)
        {
        }
        ...
        public void CreateRevonationPLine(List<Entity> entities)
        {
            ...
            entities.Add(Helper.CreateLine(BeamGeometry.BottomRightSecondRevonation.TopLeft,
                BeamGeometry.BottomRightSecondRevonation.BottomLeft,
        ...
        public void CreateHatch(List<Entity> entities)
        {
            var revoHatch = new List<Point2D>() {
                BeamGeometry.SecondRevonation.TopLeft,
                BeamGeometry.FirstRevonation.BottomLeft,
                BeamGeometry.FirstRevonation.BottomRight,
                BeamGeometry.SecondRevonation.TopRight,
                BeamGeometry.Beam.TopRight,
                BeamGeometry.Beam.BotomRight,
                BeamGeometry.Beam.ConcreateBottomRight,
                BeamGeometry.BeamHole.BottomLeft,
